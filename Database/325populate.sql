...
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0001', '1234567890123456', '01-Jan-2022', '123', '0001');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0001', '0001', '01-Jan-2022', 100, 0.1, '0001', '0001' );

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0011', '0001', '01-Jan-2022', 100, 0.1, '0001', '0001');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0002', '5467413115761230', '08-Mar-2022', '123', '0002');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0002', '0002', '08-Feb-2022', 490, 0.5, '0002', '0002');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0022', '0002', '08-Feb-2022', 490, 0.5, '0002', '0002');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0003', '1234577890123499', '01-Jan-2025', '489', '0003');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0003', '0003', '21-Jan-2023', 4, 7.25, '0003', '0003');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0033', '0003', '21-Jan-2023', 4, 7.25, '0003', '0003');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0004', '1234567990123456', '01-Jan-2027', '454', '0004');
...
-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0004', '0004', '11-March-2023', 666, 7.25, '0004', '0004');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0044', '0004', '11-March-2023', 666, 7.25, '0004', '0004');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0005', '9876543210987654', '01-Dec-2027', '789','0005');
...
-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0005', '0005', '28-Nov-2023', 150, 0.15, '0005', '0005');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0055', '0005', '28-Nov-2023', 150, 0.15, '0005', '0005');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0006', '1111222233334444', '01-Dec-2027', '222','0006');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0006', '0006', '28-Nov-2023', 120, 0.12, '0006', '0006');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0066', '0006', '28-Nov-2023', 120, 0.12, '0006' ,'0006');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0007', '9876543210987654', '13-Sep-2031', '321','0007');
...
-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0007', '0007', '05-Jan-2022', 150, 0.15, '0007', '0007');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0077', '0007', '05-Jan-2022', 150, 0.15,'0007', '0007');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0008', '4363876344987654', '17-Sep-2031', '325', '0008');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0008', '0008', '12-Jan-2022', 125, 0.15, '0008', '0008');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0088', '0008', '12-Jan-2022', 125, 0.15, '0008', '0008');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0009', '3439094578987654', '10-Aug-2031', '334','0009');
...
-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0009', '0009', '10-Feb-2022', 160, 0.15, '0009', '0009');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0099', '0009', '10-Feb-2022', 160, 0.15,'0009', '0009');
...
-- Insert statements for credit_card_info table
INSERT INTO credit_card_info (cc_id, card_number, expiration_date, CVV, cust_id)
VALUES ('0010', '0349283098987654', '27-Oct-2023', '549','0010');
...
-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0010', '0010', '18-Jul-1987', 145, 0.15, '0010', '0010');

-- Insert statements for cust_order table
INSERT INTO cust_order (order_id, cust_id, order_date, order_amount, sales_tax, cc_id, address_id)
VALUES ('0110', '0010', '18-Jul-1987', 145, 0.15, '0010', '0010');
...
*/
/*
-- Additional shipments for product with ID '0001' (P Key) and '0002' (Ink)
INSERT INTO shipment (ship_id, ship_status, one_time_order_id)
VALUES ('0003', 'Shipped', '0033');
...
-- Additional shipments for subscription orders
INSERT INTO subscription_shipment (sub_ship_id, ship_status, sub_period, sub_date, ship_date)
VALUES ('0005', 'Shipped', 'Monthly', '01-Feb-2023', '05-Feb-2023');

INSERT INTO subscription_shipment (sub_ship_id, ship_status, sub_period, sub_date, ship_date)
VALUES ('0006', 'Shipped', 'Monthly', '01-Feb-2023', '05-Feb-2023');
*/